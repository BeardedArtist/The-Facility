...
public class Oscillator : MonoBehaviour
{
    ...
    private void Update() 
    {
        ...
        float rawSinWave = Mathf.Sin(cycles * tau); // multiplying cycles by tau should give us a radian vlaue between -1 and 1

        // now we need to set our movementFactor to automatically cycle between 0 and 1 instead of -1 and 1.
        // To do this we will add rawSinWave + 1f because -1 + 1 = 0 and 1 + 1 = 2. Ths this becomes 0 to 2
        ...
        // now we need to define the new position of the object that is the offset form the original position.
